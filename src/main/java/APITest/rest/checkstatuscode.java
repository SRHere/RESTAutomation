...
// The following code will verify if the API is returning the correct response code for getallseat
...
public class checkstatuscode {
	...
	{   
		...
		RestAssured.baseURI = "http://104.211.215.154:8082";
 		...
 		Response response = httpRequest.request(Method.GET, "/getAllSeat/");
